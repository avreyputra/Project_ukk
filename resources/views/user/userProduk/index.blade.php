        ...
        <div class="container">
            <div class="product-details-top mb-2">
                <div class="row">
                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="{{asset ('template/assets/images/produk/' . $produk->foto_produk)}}" data-zoom-image="{{asset ('template/assets/images/produk/' . $produk->foto_produk)}}" alt="product image">
                    ...
                    <div class="col-md-6">
                        <div class="product-details product-details-centered mt-5">
                            ...
                            <div class="product-details-action">
                                <div class="details-action-col">
                                    <form action="{{route('addCart', $produk->id_produk)}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="product-details-quantity">
                                                <input type="number" id="qty" name="kuantitas" class="form-control" value="1" min="1" max="{{$produk->stok_produk}}" step="1" data-decimals="0" required>
                            ...
                            <div class="product-details-footer">
                                <div class="product-cat">
                                    <div class="row">
                                        <span>Category:</span>
                                        <p>{{$produk->kategori_produk->nama_kategori_produk}}</p>
                                    </div>
                                </div><!-- End .product-cat -->
