                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <fieldset class="form-group">
                                        ...
                                        <select class="form-select" id="basicSelect" name="id_kategori_produk" disabled>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea
                                            ...
                                            disabled>{{(old('deskripsi_produk')) ? old('deskripsi_produk') : $produk->deskripsi_produk}}</textarea>
                                    </div>
                                </div>
